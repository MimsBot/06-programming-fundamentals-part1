...
for venue in venues:
    if venue['capacity'] >= 150 and venue['wheelchair_accessible'] is True:
        perfect_venues.append(venue)


print(perfect_venues)

# Find the possible venues that are
# wheelchair accessible, in Toronto,
